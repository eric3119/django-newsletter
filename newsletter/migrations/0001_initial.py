# Generated by Django 2.1.8 on 2019-04-05 20:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newsletter.Article')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.AddField(
            model_name='article',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='newsletter.Message', verbose_name='message'),
        ),
