# Generated by Django 2.2 on 2019-04-24 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to='newsletter/images/%Y/%m/%d', verbose_name='Banner')),
                ('image_header', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to='newsletter/images/%Y/%m/%d', verbose_name='header')),
                ('image_footer', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to='newsletter/images/%Y/%m/%d', verbose_name='footer')),
                ('attachment', models.ManyToManyField(blank=True, to='newsletter.Attachment')),
